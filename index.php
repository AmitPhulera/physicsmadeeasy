<!DOCTYPE html>
  <html>
    ...
    <div class="nav-wrapper light-blue darken-4">
      ...
      <a href="./index.html" class="brand-logo center">Physics Made Easy</a>
	...
	<div class="section purple darken-4">
		<div class="row container">
			<h3 class="header white-text">
				Everyone Is On Time & Is Correct
			</h3>
			<span class="right">
				<p>Speed & Accuracy As They Say , Now , no one is "Late" in their submissions.</p>
				<p>And accuracy of your calculations is guaranteed to be cent percent ;) . You know 100% acuuracy is cool .</p>
				<p><i>Is'nt it??</i></p>
			</span>
		</div>
	</div>
